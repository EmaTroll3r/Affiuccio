...
const hostbutton = document.getElementById('host-lobby');
const joinbutton = document.getElementById('join-lobby');
const joinInviteButton = document.getElementById('join-lobby-by-invite');
...
if (joinInviteButton != null) {
    joinInviteButton.addEventListener('click', async function() {
        var playername = nickname.value;
        if (playername == '') {
            alert('Inserisci un nome valido');
            return;
